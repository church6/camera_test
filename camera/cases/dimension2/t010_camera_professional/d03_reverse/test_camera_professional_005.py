"""
# @filename    :  test_camera_professional_005.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d03_reverse.meta_005_reverse_aiportrait import meta_do_professional
...
def test_case_professional_meta_005_reverse_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
