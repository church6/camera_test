...
import pytest
from camera.metas.d04_flash.meta_005_flash_aiportrait import meta_do_ultrasteadyvideo
...
def test_case_ultrasteadyvideo_meta_005_flash_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
