...
import pytest
from camera.metas.d05_aiportrait.meta_001_aiportrait_loop import meta_do_ultrasteadyvideo
...
def test_case_ultrasteadyvideo_meta_001_aiportrait_loop(ulog, count):
    """
    Function :
    """
    # sanity check
