...
import pytest
from camera.metas.d05_aiportrait.meta_002_aiportrait_zoom import meta_do_ultrasteadyvideo
...
def test_case_ultrasteadyvideo_meta_002_aiportrait_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
