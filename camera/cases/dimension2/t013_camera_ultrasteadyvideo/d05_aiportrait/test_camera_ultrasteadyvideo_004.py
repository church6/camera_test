...
import pytest
from camera.metas.d05_aiportrait.meta_004_aiportrait_reverse import meta_do_ultrasteadyvideo
...
def test_case_ultrasteadyvideo_meta_004_aiportrait_reverse(ulog, count):
    """
    Function :
    """
    # sanity check
