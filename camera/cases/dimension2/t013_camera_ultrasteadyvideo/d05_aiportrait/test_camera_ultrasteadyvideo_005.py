...
import pytest
from camera.metas.d05_aiportrait.meta_005_aiportrait_flash import meta_do_ultrasteadyvideo
...
def test_case_ultrasteadyvideo_meta_005_aiportrait_flash(ulog, count):
    """
    Function :
    """
    # sanity check
