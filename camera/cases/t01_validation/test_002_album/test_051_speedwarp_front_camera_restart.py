...
from camera.cameras.hmd import restart_camera, set_zoom, set_hdr, set_flash, set_aiportrait, set_reverse, do_speedwarp, do_album_view, do_album_delete
...
def test_case00_speedwarp_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_speedwarp()
def test_case01_speedwarp_hdr(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_speedwarp()
def test_case02_speedwarp_flash(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_speedwarp()
def test_case03_speedwarp_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
