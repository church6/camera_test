...
from camera.cameras.hmd import restart_camera, set_zoom, set_hdr, set_flash, set_aiportrait, set_reverse, do_astrophoto, do_album_view, do_album_delete
...
def test_case00_astrophoto_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_astrophoto()
def test_case01_astrophoto_hdr(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_astrophoto()
def test_case02_astrophoto_flash(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_astrophoto()
def test_case03_astrophoto_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
