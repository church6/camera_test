...
from camera.cameras.hmd import restart_camera, set_zoom, set_hdr, set_flash, set_aiportrait, set_reverse, do_ultrasteadyvideo, do_album_view, do_album_delete
...
def test_case00_ultrasteadyvideo_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_ultrasteadyvideo()
def test_case01_ultrasteadyvideo_hdr(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_ultrasteadyvideo()
def test_case02_ultrasteadyvideo_flash(ulog, count):
    """
    Function :
    """
    # sanity check
...
@pytest.mark.parametrize("count", range(PYTEST_MARK_PARAMETRIZE_MAXIMUM_RANGE_NUMBER))
@pytest.mark.skip_if_do_not_support_ultrasteadyvideo()
def test_case03_ultrasteadyvideo_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
