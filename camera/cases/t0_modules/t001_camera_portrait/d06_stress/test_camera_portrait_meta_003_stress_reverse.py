"""
# @filename    :  test_camera_portrait_meta_003_stress_reverse.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d06_stress.meta_003_stress_reverse import meta_do_portrait
...
def test_case_portrait_meta_003_stress_reverse(ulog, count):
    """
    Function :
    """
    # sanity check
