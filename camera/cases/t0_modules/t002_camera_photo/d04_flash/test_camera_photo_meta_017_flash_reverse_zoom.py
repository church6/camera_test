"""
# @filename    :  test_camera_photo_meta_017_flash_reverse_zoom.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d04_flash.meta_017_flash_reverse_zoom import meta_do_photo
...
def test_case_photo_meta_017_flash_reverse_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
