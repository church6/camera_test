"""
# @filename    :  test_camera_burstshot_meta_023_hdr_aiportrait_reverse.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d02_hdr.meta_023_hdr_aiportrait_reverse import meta_do_burstshot
...
def test_case_burstshot_meta_023_hdr_aiportrait_reverse(ulog, count):
    """
    Function :
    """
    # sanity check
