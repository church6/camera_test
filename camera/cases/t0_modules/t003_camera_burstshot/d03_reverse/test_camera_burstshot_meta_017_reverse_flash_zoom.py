"""
# @filename    :  test_camera_burstshot_meta_017_reverse_flash_zoom.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d03_reverse.meta_017_reverse_flash_zoom import meta_do_burstshot
...
def test_case_burstshot_meta_017_reverse_flash_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
