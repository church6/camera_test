"""
# @filename    :  test_camera_burstshot_meta_009_stress_reverse_zoom.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d06_stress.meta_009_stress_reverse_zoom import meta_do_burstshot
...
def test_case_burstshot_meta_009_stress_reverse_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
