"""
# @filename    :  test_camera_flashshot_meta_020_zoom_reverse_flash.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d01_zoom.meta_020_zoom_reverse_flash import meta_do_flashshot
...
def test_case_flashshot_meta_020_zoom_reverse_flash(ulog, count):
    """
    Function :
    """
    # sanity check
