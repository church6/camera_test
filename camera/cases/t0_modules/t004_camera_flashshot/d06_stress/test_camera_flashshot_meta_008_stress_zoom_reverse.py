"""
# @filename    :  test_camera_flashshot_meta_008_stress_zoom_reverse.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d06_stress.meta_008_stress_zoom_reverse import meta_do_flashshot
...
def test_case_flashshot_meta_008_stress_zoom_reverse(ulog, count):
    """
    Function :
    """
    # sanity check
