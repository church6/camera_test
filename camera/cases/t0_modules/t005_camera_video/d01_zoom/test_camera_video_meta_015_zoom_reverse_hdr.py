"""
# @filename    :  test_camera_video_meta_015_zoom_reverse_hdr.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d01_zoom.meta_015_zoom_reverse_hdr import meta_do_video
...
def test_case_video_meta_015_zoom_reverse_hdr(ulog, count):
    """
    Function :
    """
    # sanity check
