"""
# @filename    :  test_camera_video_meta_022_hdr_reverse_aiportrait.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d02_hdr.meta_022_hdr_reverse_aiportrait import meta_do_video
...
def test_case_video_meta_022_hdr_reverse_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
