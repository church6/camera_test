"""
# @filename    :  test_camera_video_meta_018_reverse_zoom_aiportrait.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d03_reverse.meta_018_reverse_zoom_aiportrait import meta_do_video
...
def test_case_video_meta_018_reverse_zoom_aiportrait(ulog, count):
    """
    Function :
    """
    # sanity check
