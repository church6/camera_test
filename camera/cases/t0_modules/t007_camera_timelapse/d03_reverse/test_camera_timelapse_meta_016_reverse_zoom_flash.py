"""
# @filename    :  test_camera_timelapse_meta_016_reverse_zoom_flash.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d03_reverse.meta_016_reverse_zoom_flash import meta_do_timelapse
...
def test_case_timelapse_meta_016_reverse_zoom_flash(ulog, count):
    """
    Function :
    """
    # sanity check
