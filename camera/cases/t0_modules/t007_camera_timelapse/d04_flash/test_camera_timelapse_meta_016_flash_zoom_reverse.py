"""
# @filename    :  test_camera_timelapse_meta_016_flash_zoom_reverse.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d04_flash.meta_016_flash_zoom_reverse import meta_do_timelapse
...
def test_case_timelapse_meta_016_flash_zoom_reverse(ulog, count):
    """
    Function :
    """
    # sanity check
