"""
# @filename    :  test_camera_timelapse_meta_021_stress_flash_reverse.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d06_stress.meta_021_stress_flash_reverse import meta_do_timelapse
...
def test_case_timelapse_meta_021_stress_flash_reverse(ulog, count):
    """
    Function :
    """
    # sanity check
