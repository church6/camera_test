"""
# @filename    :  test_camera_panorama_meta_017_flash_reverse_zoom.py
# @author      :  Copyright (C) Church.ZHONG
# @date        :  2024-04-17T14:26:11+08:00
"""

import pytest
from camera.metas.d04_flash.meta_017_flash_reverse_zoom import meta_do_panorama
...
def test_case_panorama_meta_017_flash_reverse_zoom(ulog, count):
    """
    Function :
    """
    # sanity check
