"""
# @filename    :  meta_208_aiportrait_loop_zoom_reverse_hdr_flash.py
...
from camera.metas.constants import (
    META_LOOP_MAXIMUM_CYCLE_NUMBER_VIDEO,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_PHOTO,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_PORTRAIT,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_NIGHT,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_BURSTSHOT,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_FLASHSHOT,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_DUALSIGHT,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_TIMELAPSE,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_PANORAMA,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_SLOWMOTION,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_SPEEDWARP,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO,
    META_LOOP_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO,
...
from camera.metas.decorators import loop, zoom, hdr, reverse, flash, aiportrait


@aiportrait(cycle_number=META_AIPORTRAIT_MAXIMUM_CYCLE_NUMBER_NIGHT)
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_NIGHT)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_PORTRAIT)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_PHOTO)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_VIDEO)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_BURSTSHOT)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_FLASHSHOT)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_DUALSIGHT)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_TIMELAPSE)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_PANORAMA)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_SLOWMOTION)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_SPEEDWARP)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO)
...
@loop(cycle_number=META_LOOP_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO)
