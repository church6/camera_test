"""
# @filename    :  meta_015_stress_reverse_hdr.py
...
from camera.metas.constants import (
    META_STRESS_MAXIMUM_CYCLE_NUMBER_VIDEO,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_PHOTO,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_PORTRAIT,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_NIGHT,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_BURSTSHOT,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_FLASHSHOT,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_DUALSIGHT,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_TIMELAPSE,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_PANORAMA,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_SLOWMOTION,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_SPEEDWARP,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO,
    META_STRESS_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO,
    META_HDR_MAXIMUM_CYCLE_NUMBER_VIDEO,
    META_HDR_MAXIMUM_CYCLE_NUMBER_PHOTO,
    META_HDR_MAXIMUM_CYCLE_NUMBER_PORTRAIT,
    META_HDR_MAXIMUM_CYCLE_NUMBER_NIGHT,
    META_HDR_MAXIMUM_CYCLE_NUMBER_BURSTSHOT,
    META_HDR_MAXIMUM_CYCLE_NUMBER_FLASHSHOT,
    META_HDR_MAXIMUM_CYCLE_NUMBER_DUALSIGHT,
    META_HDR_MAXIMUM_CYCLE_NUMBER_TIMELAPSE,
    META_HDR_MAXIMUM_CYCLE_NUMBER_PANORAMA,
    META_HDR_MAXIMUM_CYCLE_NUMBER_SLOWMOTION,
    META_HDR_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL,
    META_HDR_MAXIMUM_CYCLE_NUMBER_SPEEDWARP,
    META_HDR_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO,
    META_HDR_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO,
...
from camera.metas.decorators import stress, hdr, reverse


@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_NIGHT)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_NIGHT)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_NIGHT)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_PORTRAIT)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_PORTRAIT)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_PORTRAIT)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_PHOTO)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_PHOTO)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_PHOTO)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_VIDEO)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_VIDEO)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_VIDEO)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_BURSTSHOT)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_BURSTSHOT)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_BURSTSHOT)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_FLASHSHOT)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_FLASHSHOT)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_FLASHSHOT)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_DUALSIGHT)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_DUALSIGHT)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_DUALSIGHT)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_TIMELAPSE)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_TIMELAPSE)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_TIMELAPSE)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_PANORAMA)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_PANORAMA)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_PANORAMA)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_SLOWMOTION)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_SLOWMOTION)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_SLOWMOTION)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_PROFESSIONAL)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_SPEEDWARP)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_SPEEDWARP)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_SPEEDWARP)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_ASTROPHOTO)
...
@stress(cycle_number=META_STRESS_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO)
@reverse(cycle_number=META_REVERSE_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO)
@hdr(cycle_number=META_HDR_MAXIMUM_CYCLE_NUMBER_ULTRASTEADYVIDEO)
