...
CAMERA_ZOOM_RADIOS = {
    "night": {"back camera": ["zoom 1", "zoom 2"], "front camera": ["default"]},
    "portrait": {"back camera": ["default"], "front camera": ["zoom 1", "zoom 2"]},
    "photo": {"back camera": ["zoom 1", "zoom 2"], "front camera": ["zoom 1", "zoom 2"]},
    "burstshot": {"back camera": ["zoom 1", "zoom 2"], "front camera": ["zoom 1", "zoom 2"]},
    "flashshot": {"default camera": ["zoom 1", "zoom 2"]},
    "video": {"back camera": ["zoom 1", "zoom 2"], "front camera": ["default"]},
