...
CAMERA_ZOOM_RADIOS = {
    "night": {"back camera": ["zoom 0.5", "zoom 1", "zoom 2", "zoom 3", "zoom 4"], "front camera": ["default"]},
    "portrait": {"back camera": ["zoom 1", "zoom 2"], "front camera": ["zoom 1", "zoom 2"]},
    "photo": {"back camera": ["zoom 0.5", "zoom 1", "zoom 2", "zoom 3", "zoom 4"], "front camera": ["zoom 1", "zoom 2"]},
    "burstshot": {"back camera": ["zoom 0.5", "zoom 1", "zoom 2", "zoom 3", "zoom 4"], "front camera": ["zoom 1", "zoom 2"]},
    "flashshot": {"default camera": ["zoom 1", "zoom 2", "zoom 3"]},
    "video": {"back camera": ["zoom 0.5", "zoom 1", "zoom 2", "zoom 3", "zoom 4"], "front camera": ["default"]},
    ...
    "slowmotion": {"back camera": ["zoom 1", "zoom 2"], "front camera": ["default"]},
    "professional": {"default camera": ["zoom 0.5", "zoom 1", "zoom 2", "zoom 3", "zoom 4"]},
    "speedwarp": {"default camera": ["default"]},
    "astrophoto": {"default camera": ["default"]},
    "ultrasteadyvideo": {"default camera": ["default"]},
}
